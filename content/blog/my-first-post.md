...
date: "2026-01-05" 
excerpt: "Exploring the intersection of law and technology through Graph Neural Networks, LLMs, and neuro-symbolic architectures."
...
| Technology | Application in Law |
| :--- | :--- |
| **Graph Neural Networks (GNNs)** | Representing intricate legal knowledge graphs and precedent relationships. |
| **Large Language Models (LLMs)** | Parsing, summarizing, and generating complex legal discourse. |
...
> "The law is not just a set of rules, but a human process. My goal is to ensure that AI serves as a tool for clarity and equity, rather than a 'black box' for decision-making."

**Key areas of inquiry include:**
* **Human-Centric Design:** How do judges and lawyers actually interact with AI?
...
**Let's connect!** If you're working in Legal Tech or Neuro-Symbolic AI, I'd love to exchange ideas.